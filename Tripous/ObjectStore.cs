        ...
        static public string RegisterObjectsOf(Assembly Assembly)
        {
            ...
            if (!assemblies.Contains(Assembly))
            {
                ...
                foreach (Type Type in Types)
                {
                    ...
                    /* ================================================================================================ */
                    /* type is decorated with ResourceProviderAttribute */
                    try
                    {
                        if (Type.IsDefined(typeof(ResourceProviderAttribute), false) && Type.ImplementsInterface(typeof(Tripous.IResourceProvider)))
                        {
                            //ResourceProviderAttribute attr = Attribute.GetCustomAttribute(Type, typeof(ResourceProviderAttribute), false) as ResourceProviderAttribute;
