...
namespace Tripous
{
    ...
    static public partial class Sys
    {
        ...
        /// </summary>
        public static string GeneratePassword(int Length = 10, bool UsePunctuation = true, bool UseSpace = false)
        {
            const string PunctuationSet = @"!@#$%^*()_-+=[{]};:>|./?"; // exclude & and < 
        ...
        /// </summary>
        static public ISessionData SessionData { get; set; }
